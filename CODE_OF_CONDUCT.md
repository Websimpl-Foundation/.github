...
If you believe someone is violating the code of conduct, we ask that you report it by emailing [websimpl.webservices@gmail.com](mailto:websimpl.webservices@gmail.com). Please include your name and a description of the incident, and we will get back to you ASAP.

Sometimes, participants violating the Code of Conduct are unaware that their behavior is harmful, and an open conversation clears things up to move forward. However, if a participant continues with the behavior, the Websimpl team may take any action they deem appropriate, up to and including expulsion from all Websimpl spaces and identification of the participant as a harasser to other Websimpl members or the general public.
